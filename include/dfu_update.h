...
#define DFU_UPGRADE_CMD_STAT_0x03		0x03
#define DFU_UPGRADE_CMD_STAT_DONE		0x05
...
struct DFU_SIM3U1XX{
	...
	uint8_t total_update_nums;
	uint8_t updating_frame_index;	
